...
class TestCoroutineCommunicatorA(asynctest.TestCase):
    ...
    async def new_communicator(self, settings=None):
    ...
    def setUp(self):
        super(TestCoroutineCommunicatorA, self).setUp()
        self.loop = asyncio.new_event_loop()
        self.communicator = self.loop.run_until_complete(self.new_communicator())

    def tearDown(self):
        self.loop.run_until_complete(self.comunicator.disconnect())
        super(TestCoroutineCommunicatorA, self).tearDown()
